\documentclass[11pt, fontset = fandol, svgnames]{ctexart}

\usepackage[hidelinks, colorlinks]{hyperref}
\usepackage[os = mac]{menukeys}
\usepackage{fontawesome5, fancyhdr, hologo,   
            subcaption,   twemojis, tikz }
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{.48\linewidth}
    ...
    \caption{\keys{\faWindows}+\keys{G} 呼出Xbox里的截图键，还能录屏}
  \end{subfigure}
  \begin{subfigure}{.48\linewidth}
    \centering
    \tikz
      {
        ...
        \node [ minimum width  = 1.65em,   outer sep = 3pt,
                ...
                fill = qq, below left,     rounded corners
              ] (b) at (a.north east) {\textcolor{white}\faQq};
      }%
    \tikz
      {
        \node [ inner sep = 0pt ] (a)
...
\begin{center}
  \begin{minipage}{.64\linewidth}
    \tikz
      {
        \node [ scale = 9, inner sep = 0pt ] (sweat) {\twemoji{1f605}};
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item 效果可截图，但\emph{源代码不要截图！\textcolor{red}{不要拍屏幕！}}%
      \footnote{Windows / macOS / Ubuntu 系统均有截图工具. 在交流群中拍屏提问者，
        管理员有权直接撤回.}
